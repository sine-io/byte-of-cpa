...
func (e *AntigravityExecutor) refreshToken(ctx context.Context, auth *cliproxyauth.Auth) (*cliproxyauth.Auth, error) {
	...
	form := url.Values{}
	form.Set("client_id", firstNonEmpty(metaStringValue(auth.Metadata, "client_id"), antigravityauth.OAuthClientID()))
	form.Set("client_secret", firstNonEmpty(metaStringValue(auth.Metadata, "client_secret"), antigravityauth.OAuthClientSecret()))
